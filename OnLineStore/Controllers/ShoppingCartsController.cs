...
namespace OnLineStore.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShoppingCartID,CustomerId,Amount")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShoppingCartID,CustomerId,Amount")] ShoppingCart shoppingCart)
        {
